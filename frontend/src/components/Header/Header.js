    ...
    <Navbar>
      ...
      <NavbarContent justify="end">
        <NavbarItem>
          ...
          <Button as={Link} className="flex items-center mr-2 text-lg italic font-semibold hover:scale-95 active:scale-95" color="warning" href="https://discord.com/api/oauth2/authorize?client_id=1195266447006502942&response_type=code&redirect_uri=http%3A%2F%2F127.0.0.1%2Flink%2Fdiscord&scope=identify+guilds+email+connections+guilds.join" variant="flat">
