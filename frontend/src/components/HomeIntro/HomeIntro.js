...
function HomeIntro() {
  ...
  return (
    ...
    <div className="relative pb-16 overflow-hidden isolate">
      ...
      <div className="px-6 pt-10 pb-24 mx-auto max-w-7xl sm:pb-32 lg:flex lg:px-8 lg:py-20">
        <div className="flex-shrink-0 max-w-2xl mx-auto lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <div className="flex items-center mt-10 gap-x-6">
            ...
            <a className="text-sm font-semibold leading-6 text-white" href="/#HomeUsage">Learn more <span aria-hidden="true">→</span></a>
          </div>
        </div>
